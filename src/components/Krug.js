...
import KrugPl from "../assets/krugPl.png";
...
const Krug = () => {
  ...
  const [activeThumb, setActiveThumb] = useState(KrugPl);
  ...
  return (
    <div>
      ...
      <div className="flex w-full md:w-[90%] flex-col md:flex-row">
          ...
          <div className="items-center flex flex-col w-[350px]">
            ...
            <div className="flex w-[300px] md:w-[330px] lg:w-[400px]">
              <div
                ...
                className="cursor-pointer flex mt-14 w-[70px] border-2 rounded-md hover:bg-gray-200 hover:border-[#3b63c7] transition-all hover:w-[80px] ease-in-out duration-500 items-center"
              >
                <img src={KrugPl} />
              </div>
              <div
              ...
              <div
                ...
                className="cursor-pointer ml-4 flex mt-14 w-[70px] border-2 rounded-md hover:bg-gray-200 hover:border-orange-300 transition-all hover:w-[80px] ease-in-out duration-500 items-center"
              >
                <img src={KrugOr} />
              </div>
              <div
              ...
              <div
                ...
                className="cursor-pointer ml-4 flex mt-14 w-[70px] border-2 rounded-md hover:bg-gray-200 hover:border-[#3BC77E] transition-all hover:w-[80px] ease-in-out duration-500 items-center"
              >
                <img src={KrugZl} />
              </div>
            </div>
        ...
        <div className="mt-14 flex flex-col w-[95%] md:w-full md:pl-3">
          <h3 className="text-3xl font-bold text-left pb-7">Pet ID tag krug</h3>
      ...
      <div className="flex justify-evenly mt-12 flex-col md:flex-row">
        ...
        <div className="pl-0 lg:pl-12 flex items-center flex-col py-7 md:py-0">
          <label htmlFor="imeLjubimca" className="mr-3">
        ...
        <div className="pl-0 md:pl-2 lg:pl-12 flex items-center flex-col py-7 md:py-0">
          <label htmlFor="imeLjubimca" className="mr-3">
