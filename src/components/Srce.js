      ...
      <div className="flex w-full md:w-[90%] flex-col md:flex-row">
        <div className="w-full mt-2 flex justify-around">
          <div className="items-center flex flex-col w-[350px]">
            <div
              id="srce"
              className=" mt-7 w-[350px] border-2 rounded-md hover:bg-gray-200 hover:border-[#3BC77E] transition-all hover:w-[370px] ease-in-out duration-500"
            >
        ...
        <div className="mt-14 flex flex-col w-[95%] md:w-full">
          <h3 className="text-3xl font-bold text-left pb-7">Pet ID tag srce</h3>
